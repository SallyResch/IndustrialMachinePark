...
namespace IndustrialMachinePark.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Machine>().HasData(new Machine { Name = "Owen Medium", LatestData = "The machine is ready to start", IsOnline = true });
            modelBuilder.Entity<Machine>().HasData(new Machine { Name = "Owen Large", LatestData = "The machine is ready to start", IsOnline = true });
        }
    }
